                                    ...
                                    <form action="addProducts" method="post">
                                        <div class="row addProductsForm">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="describe" placeholder="Input Products Describe" required>
                                                <input type="number" name="quantity" placeholder="Input Products Quantity" required>
                                                <input type="number" name="price" placeholder="Input Products Price" required>
                                                <input type="text" name="image" placeholder="Input Products image link" required>
