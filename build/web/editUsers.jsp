            ...
            <div class="row">
                ...
                <div class="col-md-10 animationAdd">
                    <div class="row"><div class="col-1"></div>
                        <div class="col-md-10">
                            <div class="row">
                                <h1 style="margin-top: 7px;">Edit Users</h1>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="editUsers" method="post">
                                        <div class="row addProductsForm">
                                            <div class="col-md-1">
                                                ...
                                                <inputProducts>Role</inputProducts>
                                                <inputProducts>Cart</inputProducts>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="number" name="role" value="${p.getRole()}" required>
                                                <input type="text" name="cart" value="${p.getCart()}" readonly>
                                                <input type="number" name="balance" value="${p.getBalance()}" required>
                                                ...
                                                <input type="submit" value="UPDATE" style="margin-top: -3px;">
                                            </div>
                                        </div>
                                    </form>
                                </div>
