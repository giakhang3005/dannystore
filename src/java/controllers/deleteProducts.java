...
public class deleteProducts extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean deleteStatus = d.deleteProducts(id);
        if(deleteStatus) {
            session.setAttribute("msg", "Successfully deleted Product with ID = " + id + "!");
            session.setAttribute("err", "");
        } else {
            session.setAttribute("msg", "");
            session.setAttribute("err", "Unable to delete Product with ID = " + id + "!");
        }
